...
class DailyBriefRepositoryImpl @Inject constructor(
    ...
    override suspend fun deleteSavedArtworksByWeekday(weekday: String, isFreeTrail: Boolean) = savedArtworksDao.deleteSavedArtworksByWeekday(weekday, isFreeTrail)
